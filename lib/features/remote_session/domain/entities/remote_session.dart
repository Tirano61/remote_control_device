...
/// does — and the timestamps (`createdAt`, `connectedAt`, `endedAt`) and
/// `endedBy` are absent because nothing here reads them: the tablet learns that
/// a session ended by no longer finding it in
/// `GET /device/remote-sessions/current`, not by inspecting how it ended.
...
class RemoteSession extends Equatable {
  ...
  @override
  List<Object?> get props => [id, supportRequestId, status, technician];
}
